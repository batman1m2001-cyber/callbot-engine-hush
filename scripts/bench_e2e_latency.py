...
async def measure_one_call(call_id: int, wav_file: str, triton_client, llm_client):
    ...
    result = await loop.run_in_executor(None, lambda: triton_client.infer(
    ...
    fs2_result = await loop.run_in_executor(None, lambda: tts_client.infer(
    ...
    hifi_result = await loop.run_in_executor(None, lambda: tts_client.infer(
